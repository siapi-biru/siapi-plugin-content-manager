...
// Here's the file: siapi/docs/3.0.0-beta.x/guides/custom-admin.md#update-the-content-manager
// Also the siapi-generate-plugins/files/admin/src/index.js needs to be updated
// IF THE DOC IS NOT UPDATED THE PULL REQUEST WILL NOT BE MERGED

import { dateFormats as defaultDateFormats } from 'siapi-helper-plugin';
