...
const { PUBLISHED_AT_ATTRIBUTE } = require('siapi-utils').contentTypes.constants;
...
module.exports = {
  async find(ctx) {
    ...
    const modelDef = _component ? siapi.db.getModel(_component) : siapi.db.getModel(model);
    ...
    const target = siapi.db.getModelByAssoc(attr);
